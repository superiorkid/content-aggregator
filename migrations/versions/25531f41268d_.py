...
Revision ID: 25531f41268d
Revises: 
Create Date: 2022-05-09 13:29:58.294661
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('blog_name', sa.String(), nullable=True),
    sa.Column('blog_img_url', sa.String(), nullable=True),
